...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustSlsAreaAddrDepdntInfo CustSlsAreaAddrDepdntInfo}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustSlsAreaAddrDepdntInfoField<FieldT >
    extends EntityField<CustSlsAreaAddrDepdntInfo, FieldT>
    implements CustSlsAreaAddrDepdntInfoSelectable
{
     ...
     */
    public CustSlsAreaAddrDepdntInfoField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustSlsAreaAddrDepdntInfoField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
