...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPFinancialServicesReporting BPFinancialServicesReporting} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPFinancialServicesReportingLink BPFinancialServicesReportingLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPFinancialServicesReportingOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPFinancialServicesReportingLink<ObjectT>
    implements OneToOneLink<BPFinancialServicesReporting, ObjectT>
{
     ...
     */
    public BPFinancialServicesReportingOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPFinancialServicesReporting> filter(
        @Nonnull
