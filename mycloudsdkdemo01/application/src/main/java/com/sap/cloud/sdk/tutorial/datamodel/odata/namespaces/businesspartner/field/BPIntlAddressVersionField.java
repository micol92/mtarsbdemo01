...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPIntlAddressVersion BPIntlAddressVersion}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPIntlAddressVersionField<FieldT >
    extends EntityField<BPIntlAddressVersion, FieldT>
    implements BPIntlAddressVersionSelectable
{
     ...
     */
    public BPIntlAddressVersionField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BPIntlAddressVersionField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
