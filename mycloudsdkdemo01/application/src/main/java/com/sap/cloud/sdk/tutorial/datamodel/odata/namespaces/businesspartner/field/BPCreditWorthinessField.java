...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPCreditWorthiness BPCreditWorthiness}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPCreditWorthinessField<FieldT >
    extends EntityField<BPCreditWorthiness, FieldT>
    implements BPCreditWorthinessSelectable
{
     ...
     */
    public BPCreditWorthinessField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BPCreditWorthinessField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
