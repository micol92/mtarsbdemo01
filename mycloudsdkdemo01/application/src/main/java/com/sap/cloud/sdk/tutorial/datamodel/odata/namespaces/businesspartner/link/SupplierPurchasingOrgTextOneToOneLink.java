...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierPurchasingOrgText SupplierPurchasingOrgText} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.SupplierPurchasingOrgTextLink SupplierPurchasingOrgTextLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SupplierPurchasingOrgTextOneToOneLink<ObjectT extends VdmObject<?> >
    extends SupplierPurchasingOrgTextLink<ObjectT>
    implements OneToOneLink<SupplierPurchasingOrgText, ObjectT>
{
     ...
     */
    public SupplierPurchasingOrgTextOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<SupplierPurchasingOrgText> filter(
        @Nonnull
