...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerAlias BusinessPartnerAlias}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerAliasField<FieldT >
    extends EntityField<BusinessPartnerAlias, FieldT>
    implements BusinessPartnerAliasSelectable
{
     ...
     */
    public BusinessPartnerAliasField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerAliasField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
