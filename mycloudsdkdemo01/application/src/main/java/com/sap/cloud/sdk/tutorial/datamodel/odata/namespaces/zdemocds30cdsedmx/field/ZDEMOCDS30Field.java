...
package com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.zdemocds30cdsedmx.field;
...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.zdemocds30cdsedmx.ZDEMOCDS30 ZDEMOCDS30}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ZDEMOCDS30Field<FieldT >
    extends EntityField<ZDEMOCDS30, FieldT>
    implements ZDEMOCDS30Selectable
{
     ...
     */
    public ZDEMOCDS30Field(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ZDEMOCDS30Field(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
