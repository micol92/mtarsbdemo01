...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusPartAddrDepdntTaxNmbr BusPartAddrDepdntTaxNmbr} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BusPartAddrDepdntTaxNmbrLink BusPartAddrDepdntTaxNmbrLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusPartAddrDepdntTaxNmbrOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusPartAddrDepdntTaxNmbrLink<ObjectT>
    implements OneToOneLink<BusPartAddrDepdntTaxNmbr, ObjectT>
{
     ...
     */
    public BusPartAddrDepdntTaxNmbrOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusPartAddrDepdntTaxNmbr> filter(
        @Nonnull
