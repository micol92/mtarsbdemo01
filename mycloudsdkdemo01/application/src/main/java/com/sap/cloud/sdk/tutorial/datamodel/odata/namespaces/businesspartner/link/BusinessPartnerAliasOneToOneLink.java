...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerAlias BusinessPartnerAlias} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BusinessPartnerAliasLink BusinessPartnerAliasLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerAliasOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerAliasLink<ObjectT>
    implements OneToOneLink<BusinessPartnerAlias, ObjectT>
{
     ...
     */
    public BusinessPartnerAliasOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerAlias> filter(
        @Nonnull
