...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustUnldgPtAddrDepdntInfo CustUnldgPtAddrDepdntInfo} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustUnldgPtAddrDepdntInfoLink CustUnldgPtAddrDepdntInfoLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustUnldgPtAddrDepdntInfoOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustUnldgPtAddrDepdntInfoLink<ObjectT>
    implements OneToOneLink<CustUnldgPtAddrDepdntInfo, ObjectT>
{
     ...
     */
    public CustUnldgPtAddrDepdntInfoOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustUnldgPtAddrDepdntInfo> filter(
        @Nonnull
