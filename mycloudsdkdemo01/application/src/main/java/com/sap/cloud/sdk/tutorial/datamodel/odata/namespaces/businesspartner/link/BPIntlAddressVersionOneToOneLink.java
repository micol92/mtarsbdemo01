...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPIntlAddressVersion BPIntlAddressVersion} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPIntlAddressVersionLink BPIntlAddressVersionLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPIntlAddressVersionOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPIntlAddressVersionLink<ObjectT>
    implements OneToOneLink<BPIntlAddressVersion, ObjectT>
{
     ...
     */
    public BPIntlAddressVersionOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPIntlAddressVersion> filter(
        @Nonnull
