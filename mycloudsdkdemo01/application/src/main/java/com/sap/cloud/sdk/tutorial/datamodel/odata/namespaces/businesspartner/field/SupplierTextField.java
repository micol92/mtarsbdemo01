...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierText SupplierText}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierTextField<FieldT >
    extends EntityField<SupplierText, FieldT>
    implements SupplierTextSelectable
{
     ...
     */
    public SupplierTextField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SupplierTextField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
