...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerUnloadingPoint CustomerUnloadingPoint} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustomerUnloadingPointLink CustomerUnloadingPointLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerUnloadingPointOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerUnloadingPointLink<ObjectT>
    implements OneToOneLink<CustomerUnloadingPoint, ObjectT>
{
     ...
     */
    public CustomerUnloadingPointOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerUnloadingPoint> filter(
        @Nonnull
