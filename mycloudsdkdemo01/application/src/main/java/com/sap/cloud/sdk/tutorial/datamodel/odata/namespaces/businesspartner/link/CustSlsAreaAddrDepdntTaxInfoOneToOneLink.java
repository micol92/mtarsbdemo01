...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustSlsAreaAddrDepdntTaxInfo CustSlsAreaAddrDepdntTaxInfo} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustSlsAreaAddrDepdntTaxInfoLink CustSlsAreaAddrDepdntTaxInfoLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustSlsAreaAddrDepdntTaxInfoOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustSlsAreaAddrDepdntTaxInfoLink<ObjectT>
    implements OneToOneLink<CustSlsAreaAddrDepdntTaxInfo, ObjectT>
{
     ...
     */
    public CustSlsAreaAddrDepdntTaxInfoOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustSlsAreaAddrDepdntTaxInfo> filter(
        @Nonnull
