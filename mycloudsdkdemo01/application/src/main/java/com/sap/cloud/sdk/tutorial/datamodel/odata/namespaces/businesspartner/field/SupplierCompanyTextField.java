...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierCompanyText SupplierCompanyText}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierCompanyTextField<FieldT >
    extends EntityField<SupplierCompanyText, FieldT>
    implements SupplierCompanyTextSelectable
{
     ...
     */
    public SupplierCompanyTextField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SupplierCompanyTextField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
