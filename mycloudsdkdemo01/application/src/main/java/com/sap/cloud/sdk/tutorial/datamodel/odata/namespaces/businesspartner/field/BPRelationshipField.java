...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPRelationship BPRelationship}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPRelationshipField<FieldT >
    extends EntityField<BPRelationship, FieldT>
    implements BPRelationshipSelectable
{
     ...
     */
    public BPRelationshipField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BPRelationshipField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
