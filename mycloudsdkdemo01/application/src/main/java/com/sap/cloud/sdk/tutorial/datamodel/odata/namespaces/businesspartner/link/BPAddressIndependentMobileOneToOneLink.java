...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPAddressIndependentMobile BPAddressIndependentMobile} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPAddressIndependentMobileLink BPAddressIndependentMobileLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPAddressIndependentMobileOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPAddressIndependentMobileLink<ObjectT>
    implements OneToOneLink<BPAddressIndependentMobile, ObjectT>
{
     ...
     */
    public BPAddressIndependentMobileOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPAddressIndependentMobile> filter(
        @Nonnull
