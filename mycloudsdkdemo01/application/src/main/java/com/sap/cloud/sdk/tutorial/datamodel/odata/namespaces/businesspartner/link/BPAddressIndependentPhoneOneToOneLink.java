...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPAddressIndependentPhone BPAddressIndependentPhone} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPAddressIndependentPhoneLink BPAddressIndependentPhoneLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPAddressIndependentPhoneOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPAddressIndependentPhoneLink<ObjectT>
    implements OneToOneLink<BPAddressIndependentPhone, ObjectT>
{
     ...
     */
    public BPAddressIndependentPhoneOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPAddressIndependentPhone> filter(
        @Nonnull
