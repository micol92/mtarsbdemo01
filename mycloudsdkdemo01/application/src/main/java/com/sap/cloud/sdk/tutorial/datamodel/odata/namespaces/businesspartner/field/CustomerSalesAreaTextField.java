...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerSalesAreaText CustomerSalesAreaText}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerSalesAreaTextField<FieldT >
    extends EntityField<CustomerSalesAreaText, FieldT>
    implements CustomerSalesAreaTextSelectable
{
     ...
     */
    public CustomerSalesAreaTextField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerSalesAreaTextField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
