...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierText SupplierText} to other entities. Instances of this object are used in query modifier methods of the entity
...
public class SupplierTextLink<ObjectT extends VdmObject<?> >
    extends EntityLink<SupplierTextLink<ObjectT> , SupplierText, ObjectT>
    implements SupplierTextSelectable
{
    ...
    @Nonnull
    @Override
    protected SupplierTextLink<ObjectT> translateLinkType(final EntityLink<SupplierTextLink<ObjectT> , SupplierText, ObjectT> link) {
