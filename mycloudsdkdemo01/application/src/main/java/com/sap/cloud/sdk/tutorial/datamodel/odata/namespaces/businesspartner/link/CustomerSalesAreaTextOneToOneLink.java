...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerSalesAreaText CustomerSalesAreaText} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustomerSalesAreaTextLink CustomerSalesAreaTextLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerSalesAreaTextOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerSalesAreaTextLink<ObjectT>
    implements OneToOneLink<CustomerSalesAreaText, ObjectT>
{
     ...
     */
    public CustomerSalesAreaTextOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerSalesAreaText> filter(
        @Nonnull
