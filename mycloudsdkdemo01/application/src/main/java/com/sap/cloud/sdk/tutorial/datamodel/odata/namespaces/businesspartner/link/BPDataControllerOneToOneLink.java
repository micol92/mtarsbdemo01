...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPDataController BPDataController} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPDataControllerLink BPDataControllerLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPDataControllerOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPDataControllerLink<ObjectT>
    implements OneToOneLink<BPDataController, ObjectT>
{
     ...
     */
    public BPDataControllerOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPDataController> filter(
        @Nonnull
