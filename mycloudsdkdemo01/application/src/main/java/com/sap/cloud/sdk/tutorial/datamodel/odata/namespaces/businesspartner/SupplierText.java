...
import com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.field.SupplierTextField;
...
/**
 * Supplier Text<p></p><p>Original entity name from the Odata EDM: <b>A_SupplierTextType</b></p>
 * 
 */
@Builder
@Data
...
public class SupplierText
    extends VdmEntity<SupplierText>
{
     ...
     * 
     */
    public final static SupplierTextField<String> LONG_TEXT_ID = new SupplierTextField<String>("LongTextID");
    /**
     ...
     * 
     */
    public final static SupplierTextField<String> LONG_TEXT = new SupplierTextField<String>("LongText");
     ...
     */
    @Nonnull
    public static<T >SupplierTextField<T> field(
        @Nonnull
