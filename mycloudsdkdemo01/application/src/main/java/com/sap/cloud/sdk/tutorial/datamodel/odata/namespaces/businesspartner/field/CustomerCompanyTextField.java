...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerCompanyText CustomerCompanyText}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerCompanyTextField<FieldT >
    extends EntityField<CustomerCompanyText, FieldT>
    implements CustomerCompanyTextSelectable
{
     ...
     */
    public CustomerCompanyTextField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerCompanyTextField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
