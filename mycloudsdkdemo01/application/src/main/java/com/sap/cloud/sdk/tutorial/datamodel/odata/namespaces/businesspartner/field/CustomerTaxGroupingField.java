...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerTaxGrouping CustomerTaxGrouping}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerTaxGroupingField<FieldT >
    extends EntityField<CustomerTaxGrouping, FieldT>
    implements CustomerTaxGroupingSelectable
{
     ...
     */
    public CustomerTaxGroupingField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerTaxGroupingField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
