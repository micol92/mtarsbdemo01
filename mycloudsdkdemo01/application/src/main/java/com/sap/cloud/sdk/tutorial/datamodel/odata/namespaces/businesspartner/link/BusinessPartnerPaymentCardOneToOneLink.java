...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerPaymentCard BusinessPartnerPaymentCard} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BusinessPartnerPaymentCardLink BusinessPartnerPaymentCardLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerPaymentCardOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerPaymentCardLink<ObjectT>
    implements OneToOneLink<BusinessPartnerPaymentCard, ObjectT>
{
     ...
     */
    public BusinessPartnerPaymentCardOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerPaymentCard> filter(
        @Nonnull
