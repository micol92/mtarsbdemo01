...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustAddrDepdntInformation CustAddrDepdntInformation} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustAddrDepdntInformationLink CustAddrDepdntInformationLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustAddrDepdntInformationOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustAddrDepdntInformationLink<ObjectT>
    implements OneToOneLink<CustAddrDepdntInformation, ObjectT>
{
     ...
     */
    public CustAddrDepdntInformationOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustAddrDepdntInformation> filter(
        @Nonnull
