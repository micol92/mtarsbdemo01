...
/**
 * Fluent helper to fetch a single {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BuPaIdentification BuPaIdentification} entity using key fields. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
    ...
    extends FluentHelperByKey<BuPaIdentificationByKeyFluentHelper, BuPaIdentification, BuPaIdentificationSelectable>
{
    ...
    /**
     * Creates a fluent helper object that will fetch a single {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BuPaIdentification BuPaIdentification} entity with the provided key field values. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     * 
     * @param entityCollection
     *     Entity Collection to be used to fetch a single {@code BuPaIdentification}
    ...
    public BuPaIdentificationByKeyFluentHelper(
        ...
        @Nonnull
        final String entityCollection, final String businessPartner, final String bPIdentificationType, final String bPIdentificationNumber) {
