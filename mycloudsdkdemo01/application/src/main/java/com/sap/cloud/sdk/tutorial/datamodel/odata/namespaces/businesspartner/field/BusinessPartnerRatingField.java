...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerRating BusinessPartnerRating}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerRatingField<FieldT >
    extends EntityField<BusinessPartnerRating, FieldT>
    implements BusinessPartnerRatingSelectable
{
     ...
     */
    public BusinessPartnerRatingField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerRatingField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
