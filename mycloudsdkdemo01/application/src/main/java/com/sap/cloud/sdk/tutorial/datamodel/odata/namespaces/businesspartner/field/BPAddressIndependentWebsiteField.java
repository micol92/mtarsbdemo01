...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPAddressIndependentWebsite BPAddressIndependentWebsite}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPAddressIndependentWebsiteField<FieldT >
    extends EntityField<BPAddressIndependentWebsite, FieldT>
    implements BPAddressIndependentWebsiteSelectable
{
     ...
     */
    public BPAddressIndependentWebsiteField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BPAddressIndependentWebsiteField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
