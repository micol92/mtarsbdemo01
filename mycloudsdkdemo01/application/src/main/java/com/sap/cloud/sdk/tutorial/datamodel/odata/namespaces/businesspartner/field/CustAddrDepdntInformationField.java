...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustAddrDepdntInformation CustAddrDepdntInformation}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustAddrDepdntInformationField<FieldT >
    extends EntityField<CustAddrDepdntInformation, FieldT>
    implements CustAddrDepdntInformationSelectable
{
     ...
     */
    public CustAddrDepdntInformationField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustAddrDepdntInformationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
