...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPAddrDepdntIntlLocNumber BPAddrDepdntIntlLocNumber} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPAddrDepdntIntlLocNumberLink BPAddrDepdntIntlLocNumberLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPAddrDepdntIntlLocNumberOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPAddrDepdntIntlLocNumberLink<ObjectT>
    implements OneToOneLink<BPAddrDepdntIntlLocNumber, ObjectT>
{
     ...
     */
    public BPAddrDepdntIntlLocNumberOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPAddrDepdntIntlLocNumber> filter(
        @Nonnull
