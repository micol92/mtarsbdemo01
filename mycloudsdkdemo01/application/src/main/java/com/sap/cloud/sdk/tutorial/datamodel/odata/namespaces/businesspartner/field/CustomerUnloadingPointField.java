...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerUnloadingPoint CustomerUnloadingPoint}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerUnloadingPointField<FieldT >
    extends EntityField<CustomerUnloadingPoint, FieldT>
    implements CustomerUnloadingPointSelectable
{
     ...
     */
    public CustomerUnloadingPointField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerUnloadingPointField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
