...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPEmployment BPEmployment} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPEmploymentLink BPEmploymentLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPEmploymentOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPEmploymentLink<ObjectT>
    implements OneToOneLink<BPEmployment, ObjectT>
{
     ...
     */
    public BPEmploymentOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPEmployment> filter(
        @Nonnull
