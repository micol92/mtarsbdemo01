...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerIsBank BusinessPartnerIsBank}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerIsBankField<FieldT >
    extends EntityField<BusinessPartnerIsBank, FieldT>
    implements BusinessPartnerIsBankSelectable
{
     ...
     */
    public BusinessPartnerIsBankField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerIsBankField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
