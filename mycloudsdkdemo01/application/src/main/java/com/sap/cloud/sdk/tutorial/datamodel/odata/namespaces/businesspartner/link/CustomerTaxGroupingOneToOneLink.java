...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerTaxGrouping CustomerTaxGrouping} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustomerTaxGroupingLink CustomerTaxGroupingLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerTaxGroupingOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerTaxGroupingLink<ObjectT>
    implements OneToOneLink<CustomerTaxGrouping, ObjectT>
{
     ...
     */
    public CustomerTaxGroupingOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerTaxGrouping> filter(
        @Nonnull
