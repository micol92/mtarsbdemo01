...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerText CustomerText}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerTextField<FieldT >
    extends EntityField<CustomerText, FieldT>
    implements CustomerTextSelectable
{
     ...
     */
    public CustomerTextField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CustomerTextField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
