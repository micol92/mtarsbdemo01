...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerPaymentCard BusinessPartnerPaymentCard}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerPaymentCardField<FieldT >
    extends EntityField<BusinessPartnerPaymentCard, FieldT>
    implements BusinessPartnerPaymentCardSelectable
{
     ...
     */
    public BusinessPartnerPaymentCardField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BusinessPartnerPaymentCardField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
