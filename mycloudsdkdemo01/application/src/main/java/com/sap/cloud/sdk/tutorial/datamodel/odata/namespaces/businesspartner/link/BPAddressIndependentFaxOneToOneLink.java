...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPAddressIndependentFax BPAddressIndependentFax} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPAddressIndependentFaxLink BPAddressIndependentFaxLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPAddressIndependentFaxOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPAddressIndependentFaxLink<ObjectT>
    implements OneToOneLink<BPAddressIndependentFax, ObjectT>
{
     ...
     */
    public BPAddressIndependentFaxOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPAddressIndependentFax> filter(
        @Nonnull
