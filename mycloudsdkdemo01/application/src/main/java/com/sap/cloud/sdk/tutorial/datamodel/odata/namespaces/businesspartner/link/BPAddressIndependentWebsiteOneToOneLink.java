...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPAddressIndependentWebsite BPAddressIndependentWebsite} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPAddressIndependentWebsiteLink BPAddressIndependentWebsiteLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPAddressIndependentWebsiteOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPAddressIndependentWebsiteLink<ObjectT>
    implements OneToOneLink<BPAddressIndependentWebsite, ObjectT>
{
     ...
     */
    public BPAddressIndependentWebsiteOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPAddressIndependentWebsite> filter(
        @Nonnull
