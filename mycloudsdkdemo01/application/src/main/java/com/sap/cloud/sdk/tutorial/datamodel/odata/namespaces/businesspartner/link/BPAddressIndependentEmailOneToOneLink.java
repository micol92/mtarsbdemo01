...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPAddressIndependentEmail BPAddressIndependentEmail} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPAddressIndependentEmailLink BPAddressIndependentEmailLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPAddressIndependentEmailOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPAddressIndependentEmailLink<ObjectT>
    implements OneToOneLink<BPAddressIndependentEmail, ObjectT>
{
     ...
     */
    public BPAddressIndependentEmailOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPAddressIndependentEmail> filter(
        @Nonnull
