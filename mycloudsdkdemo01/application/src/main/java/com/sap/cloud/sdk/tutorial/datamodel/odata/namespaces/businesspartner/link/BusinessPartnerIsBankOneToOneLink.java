...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerIsBank BusinessPartnerIsBank} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BusinessPartnerIsBankLink BusinessPartnerIsBankLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerIsBankOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerIsBankLink<ObjectT>
    implements OneToOneLink<BusinessPartnerIsBank, ObjectT>
{
     ...
     */
    public BusinessPartnerIsBankOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerIsBank> filter(
        @Nonnull
