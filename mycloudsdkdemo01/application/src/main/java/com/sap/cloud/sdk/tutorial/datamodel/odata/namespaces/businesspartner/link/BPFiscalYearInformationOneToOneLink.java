...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPFiscalYearInformation BPFiscalYearInformation} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPFiscalYearInformationLink BPFiscalYearInformationLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPFiscalYearInformationOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPFiscalYearInformationLink<ObjectT>
    implements OneToOneLink<BPFiscalYearInformation, ObjectT>
{
     ...
     */
    public BPFiscalYearInformationOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPFiscalYearInformation> filter(
        @Nonnull
