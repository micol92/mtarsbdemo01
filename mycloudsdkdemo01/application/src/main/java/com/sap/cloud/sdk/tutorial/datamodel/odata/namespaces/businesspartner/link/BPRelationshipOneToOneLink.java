...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPRelationship BPRelationship} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPRelationshipLink BPRelationshipLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPRelationshipOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPRelationshipLink<ObjectT>
    implements OneToOneLink<BPRelationship, ObjectT>
{
     ...
     */
    public BPRelationshipOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPRelationship> filter(
        @Nonnull
