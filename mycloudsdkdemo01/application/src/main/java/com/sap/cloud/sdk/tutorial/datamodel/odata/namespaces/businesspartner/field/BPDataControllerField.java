...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPDataController BPDataController}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPDataControllerField<FieldT >
    extends EntityField<BPDataController, FieldT>
    implements BPDataControllerSelectable
{
     ...
     */
    public BPDataControllerField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BPDataControllerField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
