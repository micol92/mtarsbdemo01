...
/**
 * Fluent helper to fetch a single {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierPartnerFunc SupplierPartnerFunc} entity using key fields. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
    ...
    extends FluentHelperByKey<SupplierPartnerFuncByKeyFluentHelper, SupplierPartnerFunc, SupplierPartnerFuncSelectable>
{
    ...
    /**
     * Creates a fluent helper object that will fetch a single {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierPartnerFunc SupplierPartnerFunc} entity with the provided key field values. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     * 
     * @param entityCollection
     *     Entity Collection to be used to fetch a single {@code SupplierPartnerFunc}
    ...
    public SupplierPartnerFuncByKeyFluentHelper(
        ...
        @Nonnull
        final String entityCollection, final String supplier, final String purchasingOrganization, final String supplierSubrange, final String plant, final String partnerFunction, final String partnerCounter) {
