...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierCompanyText SupplierCompanyText} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.SupplierCompanyTextLink SupplierCompanyTextLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SupplierCompanyTextOneToOneLink<ObjectT extends VdmObject<?> >
    extends SupplierCompanyTextLink<ObjectT>
    implements OneToOneLink<SupplierCompanyText, ObjectT>
{
     ...
     */
    public SupplierCompanyTextOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<SupplierCompanyText> filter(
        @Nonnull
