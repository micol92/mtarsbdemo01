...
/**
 * Fluent helper to fetch a single {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerSalesArea CustomerSalesArea} entity using key fields. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
    ...
    extends FluentHelperByKey<CustomerSalesAreaByKeyFluentHelper, CustomerSalesArea, CustomerSalesAreaSelectable>
{
    ...
    /**
     * Creates a fluent helper object that will fetch a single {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustomerSalesArea CustomerSalesArea} entity with the provided key field values. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     * 
     * @param division
     *     Division<p>Constraints: Not nullable, Maximum length: 2</p>
     * @param entityCollection
     *     Entity Collection to be used to fetch a single {@code CustomerSalesArea}
     * @param servicePath
