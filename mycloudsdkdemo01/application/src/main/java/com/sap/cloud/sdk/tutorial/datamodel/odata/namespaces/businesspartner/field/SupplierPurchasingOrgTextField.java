...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.SupplierPurchasingOrgText SupplierPurchasingOrgText}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierPurchasingOrgTextField<FieldT >
    extends EntityField<SupplierPurchasingOrgText, FieldT>
    implements SupplierPurchasingOrgTextSelectable
{
     ...
     */
    public SupplierPurchasingOrgTextField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SupplierPurchasingOrgTextField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
