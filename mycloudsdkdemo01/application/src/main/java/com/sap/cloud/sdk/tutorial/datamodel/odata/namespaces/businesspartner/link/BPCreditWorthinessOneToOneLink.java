...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPCreditWorthiness BPCreditWorthiness} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPCreditWorthinessLink BPCreditWorthinessLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPCreditWorthinessOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPCreditWorthinessLink<ObjectT>
    implements OneToOneLink<BPCreditWorthiness, ObjectT>
{
     ...
     */
    public BPCreditWorthinessOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPCreditWorthiness> filter(
        @Nonnull
