...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BusinessPartnerRating BusinessPartnerRating} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BusinessPartnerRatingLink BusinessPartnerRatingLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerRatingOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerRatingLink<ObjectT>
    implements OneToOneLink<BusinessPartnerRating, ObjectT>
{
     ...
     */
    public BusinessPartnerRatingOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerRating> filter(
        @Nonnull
