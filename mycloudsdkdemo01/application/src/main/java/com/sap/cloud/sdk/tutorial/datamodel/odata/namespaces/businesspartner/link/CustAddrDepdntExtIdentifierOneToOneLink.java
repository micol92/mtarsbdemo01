...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustAddrDepdntExtIdentifier CustAddrDepdntExtIdentifier} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustAddrDepdntExtIdentifierLink CustAddrDepdntExtIdentifierLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustAddrDepdntExtIdentifierOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustAddrDepdntExtIdentifierLink<ObjectT>
    implements OneToOneLink<CustAddrDepdntExtIdentifier, ObjectT>
{
     ...
     */
    public CustAddrDepdntExtIdentifierOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustAddrDepdntExtIdentifier> filter(
        @Nonnull
