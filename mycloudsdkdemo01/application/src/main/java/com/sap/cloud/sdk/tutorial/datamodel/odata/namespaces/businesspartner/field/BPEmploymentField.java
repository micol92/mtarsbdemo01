...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPEmployment BPEmployment}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPEmploymentField<FieldT >
    extends EntityField<BPEmployment, FieldT>
    implements BPEmploymentSelectable
{
     ...
     */
    public BPEmploymentField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BPEmploymentField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
