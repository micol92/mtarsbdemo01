    ...
    extends VdmEntity<CustomerCompanyText>
{
     ...
     * 
     */
    public final static CustomerCompanyTextField<String> LONG_TEXT_ID = new CustomerCompanyTextField<String>("LongTextID");
    /**
     ...
     * 
     */
    public final static CustomerCompanyTextField<String> LONG_TEXT = new CustomerCompanyTextField<String>("LongText");
