...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.BPFinancialServicesExtn BPFinancialServicesExtn} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.BPFinancialServicesExtnLink BPFinancialServicesExtnLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPFinancialServicesExtnOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPFinancialServicesExtnLink<ObjectT>
    implements OneToOneLink<BPFinancialServicesExtn, ObjectT>
{
     ...
     */
    public BPFinancialServicesExtnOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BPFinancialServicesExtn> filter(
        @Nonnull
