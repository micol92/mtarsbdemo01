...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.CustSlsAreaAddrDepdntInfo CustSlsAreaAddrDepdntInfo} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.businesspartner.link.CustSlsAreaAddrDepdntInfoLink CustSlsAreaAddrDepdntInfoLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustSlsAreaAddrDepdntInfoOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustSlsAreaAddrDepdntInfoLink<ObjectT>
    implements OneToOneLink<CustSlsAreaAddrDepdntInfo, ObjectT>
{
     ...
     */
    public CustSlsAreaAddrDepdntInfoOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustSlsAreaAddrDepdntInfo> filter(
        @Nonnull
